    ...
    return (
      <div className="max-w-md mx-auto py-20 text-center animate-in fade-in duration-500">
        ...
        <p className="text-slate-500 font-medium mb-10">
          La operación se ha registrado correctamente y sincronizado en tiempo
          real.
        </p>
        <button
          onClick={() => {
    ...
    <div className="max-w-2xl mx-auto py-6">
      ...
      >
        ...
        <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-[#1D3146]">
              Elegir Cliente
            </label>
          ...
          <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm space-y-8">
            ...
            <div className="space-y-4">
              {items.map((item, i) => (
                <div
                  key={i}
                  className="flex gap-4 items-end animate-in fade-in zoom-in duration-300"
                >
                  ...
                  <button
                    ...
                    className="mb-3 text-rose-500 opacity-40 hover:opacity-100 transition-opacity"
      ...
      <div className="mt-8 px-6 py-4 bg-slate-100 rounded-2xl flex items-start gap-3">
        ...
        <p className="text-[10px] text-slate-400 font-bold leading-relaxed uppercase tracking-tighter">
          Nota: Al registrar una entrega, el stock se descontará automáticamente
          y el saldo pendiente del cliente aumentará.
        </p>
      </div>
    </div>
  );
