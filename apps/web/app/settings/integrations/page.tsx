      ...
      <div className="flex items-center gap-6">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-slate-500 font-medium italic">
            Conecta EntréGA con tus herramientas favoritas.
          </p>
        </div>
      </div>
          ...
          <Link
            ...
            className={`group bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm transition-all flex flex-col justify-between h-72 ${
              app.disabled
                ...
                : "hover:shadow-xl hover:shadow-[#1D3146]/5 hover:-translate-y-1"
            }`}
          >
            <div>
              <div className="flex justify-between items-start mb-6">
                <div
                  className={`w-16 h-16 ${app.color} text-white rounded-2xl flex items-center justify-center shadow-lg`}
                >
                  <app.icon size={28} />
                </div>
                <div
              ...
              <h3 className="text-xl font-black text-[#1D3146] mb-2">
                {app.name}
              </h3>
        ...
        <div className="md:col-span-2 bg-[#1D3146] text-white p-10 rounded-[3rem] relative overflow-hidden">
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-sm text-slate-400 font-medium max-w-2xl leading-relaxed">
              En EntréGA, la privacidad es nuestra brújula. Cada integración es
              aislada a nivel de base de datos. Tus tokens de acceso están
              encriptados con AES-256 y nunca se comparten entre negocios.
            </p>
            <div className="flex items-center gap-6">
