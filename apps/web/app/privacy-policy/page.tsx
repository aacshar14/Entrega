...
export default function PrivacyPage() {
  ...
  const content = {
    es: {
      ...
      subtitle:
        "Transparencia total sobre cómo protegemos tu operación y los datos de tus clientes.",
      back: "Volver al Inicio",
      verified: "Seguridad Verificada",
      lastUpdated: "Última actualización: Abril 2026",
      contactTitle: "Contacto y Eliminación de Datos",
      contactDesc:
        "Para solicitudes de acceso, corrección, exportación o eliminación definitiva de tus datos, escribe a:",
      sections: [
        {
          id: "collection",
          icon: Database,
          ...
          content:
            "Entrega recolecta información esencial para la operación logística:",
          list: [
        ...
        },
        {
          ...
          content:
            "Como proveedor de soluciones, Entrega procesa datos de Meta/WhatsApp bajo los siguientes principios:",
          list: [
        ...
        },
        {
          ...
          content:
            "Para operar Entrega, utilizamos proveedores que procesan datos cumpliendo estándares de seguridad:",
          list: [
        ...
        },
        {
          ...
          title: "Tus Derechos",
          content:
            "Eres el dueño único de tu información. Tienes derecho a exportar, modificar o solicitar la eliminación total de tu base de datos y cuenta en cualquier momento.",
        },
      ],
    },
    en: {
      ...
      subtitle:
        "Total transparency on how we protect your operations and your customers' data.",
      back: "Back to Home",
      verified: "Verified Security",
      lastUpdated: "Last updated: April 2026",
      contactTitle: "Contact & Data Deletion",
      contactDesc:
        "For access, correction, export, or permanent deletion requests, please contact:",
      sections: [
        {
          id: "collection",
          icon: Database,
          ...
          content:
            "Entrega collects essential information required for logistics operations:",
          list: [
        ...
        },
        {
          ...
          content:
            "As a solution provider, Entrega processes Meta/WhatsApp data under these principles:",
          list: [
        ...
        },
        {
          ...
          content:
            "To operate the service, Entrega uses providers that process data following high security standards:",
          list: [
        ...
        },
        {
          ...
          title: "Your Rights",
          content:
            "You are the sole owner of your information. You have the right to export, modify, or request the total deletion of your database and account at any time.",
        },
      ],
    },
  };
      ...
      <header className="bg-[#1D3146] pt-20 pb-32 px-6 relative overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="flex items-center justify-between mb-10">
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-[#56CCF2] text-xs font-black uppercase tracking-widest hover:gap-4 transition-all"
            >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-6xl font-black text-white leading-none tracking-tighter">
                {lang === "es" ? (
                  <>
                    {content.es.title.split(" ")[0]} de <br />{" "}
                    <span className="text-[#56CCF2]">
                      {content.es.title.split(" ")[2]}
                    </span>
                  </>
                ) : (
                  <span>{t.title}</span>
            ...
            <Logo
              variant="master"
              className="w-32 h-auto opacity-50 grayscale brightness-200"
            />
          </div>
        </div>
          ...
          {t.sections.map((section) => (
            <section key={section.id} className="space-y-6">
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 ${section.id === "whatsapp" ? "bg-[#56CCF2] text-[#1D3146]" : "bg-[#1D3146] text-[#56CCF2]"} rounded-2xl flex items-center justify-center shadow-lg shadow-[#1D3146]/10`}
                >
          ...
          <section className="bg-slate-50 rounded-[2.5rem] border border-slate-100 p-8 md:p-12 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm transition-all hover:shadow-md group">
                ...
                <span className="text-xl font-black text-[#1D3146] tracking-tight">
                  admin@entrega.space
                </span>
                <a
                ...
                >
                  {lang === "es" ? "Enviar Correo" : "Email Now"}{" "}
