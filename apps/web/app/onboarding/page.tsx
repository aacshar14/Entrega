    ...
    <div className="min-h-screen bg-[#EBEEF2] flex flex-col p-6 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col items-center gap-4 py-8">
         ...
         <div className="text-center">
            <h1 className="text-2xl font-black text-[#1D3146] tracking-tighter">Bienvenido a EntréGA</h1>
            <p className="text-xs text-slate-500 font-bold uppercase tracking-[0.2em] mt-1">Onboarding ChocoBites</p>
         </div>
      </div>
      ...
      <div className="max-w-md mx-auto w-full flex-grow">
         {step === 1 && (
            <div className="bg-white rounded-[2.5rem] p-8 md:p-10 shadow-2xl border border-slate-100 animate-in slide-in-from-bottom-8 duration-500">
               ...
               <h2 className="text-2xl font-black text-[#1D3146] mb-2 tracking-tight">Datos del Negocio</h2>
               <p className="text-sm text-slate-500 mb-8 font-medium">Comencemos con el nombre oficial de tu operación.</p>
         ...
         {step === 2 && (
            <div className="bg-white rounded-[2.5rem] p-8 md:p-10 shadow-2xl border border-slate-100 animate-in slide-in-from-bottom-8 duration-500">
               ...
               <p className="text-sm text-slate-500 mb-8 font-medium">Sube tu base de clientes actual para evitar capturas manuales.</p>
         ...
         {step === 3 && (
            <div className="bg-white rounded-[2.5rem] p-8 md:p-10 shadow-2xl border border-slate-100 animate-in slide-in-from-bottom-8 duration-500">
               ...
               <h2 className="text-2xl font-black text-[#1D3146] mb-2 tracking-tight">Carga de Inventario</h2>
               <p className="text-sm text-slate-500 mb-8 font-medium">Sincroniza tus existencias actuales de ChocoBites.</p>
               ...
               <div className="border-4 border-dashed border-slate-100 rounded-[2rem] p-10 text-center group hover:border-orange-200 transition-all cursor-pointer relative bg-slate-50/50">
                  ...
                  <p className="text-[10px] text-slate-400 font-bold mt-2">Formato: sku, quantity, price</p>
               </div>
         ...
         {step === 4 && (
            <div className="bg-white rounded-[2.5rem] p-8 md:p-10 shadow-2xl border border-slate-100 animate-in slide-in-from-bottom-8 duration-500">
               ...
               <h2 className="text-2xl font-black text-[#1D3146] mb-2 tracking-tight">Conectar WhatsApp</h2>
               <p className="text-sm text-slate-500 mb-8 font-medium">Habilita la comunicación con tus clientes vía WhatsApp Business.</p>
         ...
         {step === 5 && (
            <div className="bg-[#1D3146] rounded-[2.5rem] p-10 md:p-12 text-center shadow-2xl relative overflow-hidden group animate-in zoom-in-95 duration-500">
               <div className="relative z-10 flex flex-col items-center">
                  ...
                  <h2 className="text-3xl font-black text-white mb-2 tracking-tight">¡Todo Listo!</h2>
                  <p className="text-[#56CCF2] text-sm font-black uppercase tracking-[0.2em] mb-10">Tu tenant ChocoBites está listo para operar</p>
                  
                  <div className="w-full space-y-3 mb-12">
                     <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/10">
                        <span className="text-[10px] font-black uppercase tracking-widest text-[#56CCF2]">Clientes Cargados</span>
                        <CheckCircle2 size={16} className="text-[#56CCF2]" />
                     </div>
                     <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/10">
                        <span className="text-[10px] font-black uppercase tracking-widest text-[#56CCF2]">Stock Inicial Sincronizado</span>
                        <CheckCircle2 size={16} className="text-[#56CCF2]" />
                     </div>
                     <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/10">
                        <span className="text-[10px] font-black uppercase tracking-widest text-[#56CCF2]">WhatsApp Business Activo</span>
                        <CheckCircle2 size={16} className="text-[#56CCF2]" />
                     </div>
                  </div>
      ...
      <div className="py-8 text-center">
         <p className="text-[10px] text-slate-300 font-bold uppercase tracking-[0.2em]">EntréGA Onboarding Engine v1.1.0</p>
      </div>
