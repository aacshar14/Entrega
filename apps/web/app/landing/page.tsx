    ...
    <div className="min-h-screen bg-[#1D3146] text-white font-sans selection:bg-[#56CCF2]/30">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-1 gap-4">
            {[
              ...
              {
                icon: MessageSquare,
                text: "Gestiona adeudos sin anotaciones.",
              },
              { icon: Zap, text: "Recibe reportes instantáneos." },
            ].map((item, i) => (
              <div
                key={i}
                className="flex items-center gap-4 p-5 bg-white/5 rounded-2xl border border-white/5 hover:bg-white/10 transition-all"
              >
          ...
          <div className="bg-white/5 border border-white/10 rounded-[3rem] p-10 flex flex-col justify-between hover:bg-white/10 transition-all group">
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                {["Registro manual", "Dashboard", "Control de clientes"].map(
                  (feat, i) => (
                    <li
                      key={i}
                    ...
                    >
                      <CheckCircle2
                        size={18}
                        className="text-[#56CCF2] opacity-50"
                      />
                      {feat}
                    </li>
                  ),
      ...
      <footer className="py-12 border-t border-white/5 opacity-50">
        <div className="max-w-7xl mx-auto px-6 flex justify-center">
          <Logo
            variant="master"
            className="h-10 w-auto opacity-40 hover:opacity-100 transition-all"
          />
        </div>
      </footer>
    </div>
