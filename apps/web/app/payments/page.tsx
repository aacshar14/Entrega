    ...
    <div className="space-y-6 max-w-4xl">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-slate-400 font-medium">
          Control de flujo de caja para entregas realizadas
        </p>
      </div>

      <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="p-8 border-b border-slate-50 bg-slate-50/50 flex justify-between items-center">
          <span className="text-xs font-black uppercase text-slate-400 tracking-widest leading-none">
        ...
        <div className="p-4 space-y-3">
          {loading ? (
            ...
            <div className="p-10 text-center text-slate-300 font-medium italic">
            ...
            payments.map((p) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <p className="text-[10px] uppercase font-black tracking-widest text-green-600 mt-1">
                    Saldado
                  </p>
                </div>
              </div>
