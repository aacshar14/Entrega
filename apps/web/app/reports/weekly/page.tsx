    ...
    <div className="space-y-8 max-w-5xl pb-20">
      <div className="flex justify-between items-center bg-gradient-to-br from-[#1D3146] to-[#2B4764] text-white p-12 rounded-3xl shadow-2xl relative overflow-hidden border border-white/10">
        <div className="relative z-10 space-y-2">
          ...
          <p className="text-blue-200 text-lg font-medium opacity-90">
            KPIs operativos del periodo activo
          </p>
        </div>
        <div className="relative z-10 bg-white/10 backdrop-blur-3xl p-6 rounded-3xl border border-white/20 shadow-xl">
          <p className="text-blue-100 uppercase font-black tracking-wider text-[10px] leading-tight mb-2">
            Período Activo
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 flex flex-col gap-4">
          ...
          <div>
            <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px] leading-tight mb-1">
              Entregas
            </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="p-4 space-y-2">
            {loading ? (
              ...
              data.top_products.map((p, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between p-5 bg-slate-50/50 rounded-2xl hover:bg-slate-50 transition-colors"
                >
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl overflow-hidden">
          <div className="p-8 border-b border-slate-50 flex justify-between items-center">
            <h3 className="text-xl font-black text-rose-500 tracking-tight">
              🚩 Mayor impacto (Adeudo)
            </h3>
            <span className="text-[10px] font-black uppercase text-slate-300 tracking-widest">
              Cartera
            </span>
          ...
          <div className="p-4 space-y-2">
            {loading ? (
              ...
              data.top_debtors.map((d, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between p-5 bg-rose-50/30 rounded-2xl hover:bg-rose-50/50 transition-colors"
                >
                  <div className="flex items-center gap-4">
      ...
      <div className="bg-slate-50 p-6 rounded-3xl flex items-start gap-4 border border-slate-100">
        ...
        <p className="text-[11px] text-slate-500 font-medium leading-relaxed">
          Este reporte se genera dinámicamente según tu histórico. Muestra quién
          te debe más y qué producto está rotando más rápido en los últimos 7
          días.
        </p>
      </div>
    </div>
