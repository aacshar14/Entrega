    ...
    <div className="min-h-screen bg-white text-[#1D3146] font-sans selection:bg-[#56CCF2]/30">
      ...
      <header className="fixed top-0 left-0 right-0 z-[100] bg-[#1D3146] border-b border-[#1D3146]/20 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 py-4 md:py-6 flex items-center justify-between transition-all duration-300">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/login"
              className="hidden sm:block text-sm font-bold px-6 py-2.5 rounded-xl text-white/80 hover:bg-white/5 transition-all"
            >
              Log in
            </Link>
            <Link
              href="/onboarding"
              className="bg-[#56CCF2] text-[#1D3146] px-6 py-2.5 rounded-xl text-sm font-black uppercase tracking-widest shadow-xl shadow-[#1D3146]/20 hover:scale-105 active:scale-95 transition-all"
            >
              Empieza Gratis
            </Link>
          </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#56CCF2]/10 text-[#1D3146] rounded-full border border-[#56CCF2]/20">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest">
                v1.1 Pilot Launch - Open Beta
              </span>
            </div>

            <h1 className="text-5xl md:text-8xl font-black leading-[0.9] tracking-tighter">
              Inteligencia <br />
              <span className="text-[#56CCF2] italic">Logística</span> para{" "}
              <br />
              tu Negocio.
            </h1>

            <p className="text-lg md:text-xl text-slate-500 font-medium max-w-2xl leading-relaxed">
              Controla tus entregas y cobros desde WhatsApp sin errores ni
              pérdidas. Sabe exactamente cuánto vendes, cuánto te deben y qué
              tienes en inventario — en tiempo real.
            </p>
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-slate-50">
              <div className="flex items-center gap-3">
                <div className="flex -space-x-3">
                  {[
                    ...
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full border-4 border-white flex items-center justify-center font-black text-[10px]"
                ...
                <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">
                  +12 negocios ya controlan sus entregas con Entrega
                </p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest font-black italic">
                  Operación Validada
                </p>
              </div>
            </div>
            ...
            <div className="relative bg-[#1D3146] p-1.5 rounded-[3rem] shadow-2xl rotate-[1deg] group-hover:rotate-0 transition-all duration-700">
              <div className="bg-white rounded-[2.8rem] overflow-hidden aspect-[4/5] relative transition-transform duration-1000">
                <img
                  ...
                  alt="Entrega Intelligence Dashboard"
                />
      ...
      <section id="recursos" className="py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#56CCF2]">
              Pérdidas vs Control
            </h2>
            <h3 className="text-4xl md:text-5xl font-black tracking-tight italic">
              ¿Sigues controlando tu negocio con libreta o Excel?
            </h3>
            <p className="text-slate-500 font-medium italic">
              Cada error te cuesta dinero.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
            {[
              ...
              <div
                key={i}
                className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm transition-all group block hover:shadow-xl hover:shadow-[#1D3146]/5"
              >
          ...
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            ...
            <h3 className="text-4xl md:text-5xl font-black tracking-tight italic">
              Convierte WhatsApp en tu centro de operaciones
            </h3>
            <p className="text-slate-500 font-medium italic">
              Tú vendes. Entrega controla.
            </p>
          </div>
              ...
              <div className="md:w-1/2 space-y-6 text-center md:text-left">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 text-slate-300">
                    <span className="w-8 h-8 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center font-black">
                      1
                    </span>
                    <p className="font-bold">
                      Recibes mensaje: “Quiero 10 cajas”
                    </p>
                  </div>
                  <div className="flex items-center gap-4 text-slate-300">
                    <span className="w-8 h-8 rounded-full bg-blue-500/20 text-blue-400 flex items-center justify-center font-black">
                ...
                <p className="text-[#56CCF2] font-black uppercase tracking-widest text-[10px]">
                  Sin errores. Sin desorden.
                </p>
              </div>
              <div className="md:w-1/2 flex justify-center translate-y-8">
                <div className="bg-white/5 p-4 rounded-[2rem] border border-white/10 backdrop-blur-3xl shadow-inner w-full max-w-sm">
                  <img
                    ...
                    alt="Entrega WhatsApp Configuration"
                  />
                </div>
              </div>
            </div>
      ...
      <section id="precios" className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-6xl font-black text-[#1D3146] mb-8 uppercase tracking-tighter">
            Control total <span className="text-[#56CCF2]">en tiempo real</span>
          </h2>
          <div className="max-w-2xl mx-auto bg-[#1D3146] p-16 rounded-[4rem] text-white overflow-hidden relative group shadow-2xl shadow-[#1D3146]/20">
            ...
            <div className="relative z-10">
              <p className="text-[#56CCF2] font-black uppercase tracking-[0.3em] text-sm mb-6">
                Sabes exactamente qué está pasando
              </p>
              <ul className="text-left space-y-4 mb-12 max-w-xs mx-auto">
                <li className="flex items-center gap-3 text-sm font-medium">
                  <CheckCircle2 className="text-[#56CCF2]" size={18} /> Ventas
                  del día
                </li>
                <li className="flex items-center gap-3 text-sm font-medium">
                  <CheckCircle2 className="text-[#56CCF2]" size={18} />{" "}
                  Inventario actualizado
                </li>
                <li className="flex items-center gap-3 text-sm font-medium">
                  <CheckCircle2 className="text-[#56CCF2]" size={18} /> Errores
                  detectados
                </li>
                <li className="flex items-center gap-3 text-sm font-medium">
                  <CheckCircle2 className="text-[#56CCF2]" size={18} /> Intentos
                  fallidos
                </li>
              </ul>
              <Link
                href="/onboarding"
                className="inline-block w-full bg-[#56CCF2] text-[#1D3146] px-16 py-6 rounded-3xl font-black uppercase tracking-widest text-sm hover:scale-105 transition-all shadow-2xl shadow-[#56CCF2]/20"
              >
      ...
      <section className="py-32 bg-slate-50">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-10">
          ...
          <h3 className="text-4xl md:text-5xl font-black tracking-tight leading-[0.95]">
            No es solo software.{" "}
            <span className="text-[#56CCF2]">Es un sistema.</span>
          </h3>
          <p className="text-lg text-slate-500 font-medium italic">
            Entrega incluye una metodología operativa para negocios reales.
            Opera como empresa grande, sin serlo.
          </p>
        </div>
      </section>
          ...
          <div className="space-y-4 text-center md:text-left">
            ...
            <div className="space-y-4">
              <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] mb-4">
                Deja de perder dinero por desorden
              </p>
              <p className="text-xs text-slate-500 max-w-xs mx-auto md:mx-0">
                Si hoy usas libreta o Excel, ya estás perdiendo dinero.
              </p>
              <div className="flex flex-col gap-4">
                <Link
                  href="/privacy-policy"
                  className="inline-flex items-center justify-center md:justify-start gap-2 bg-[#56CCF2]/10 text-[#56CCF2] px-6 py-3 rounded-xl hover:bg-[#56CCF2]/20 transition-all text-xs font-black uppercase tracking-widest border border-[#56CCF2]/20"
                >
                  <ShieldCheck size={16} />
