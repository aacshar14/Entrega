      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-black text-[#1D3146] tracking-tight flex items-center gap-3">
            <TrendingUp className="text-[#56CCF2]" size={36} /> Inventario en
            Calle
          </h1>
          <p className="text-slate-500 font-medium mt-1">
            Control de mercancía bajo resguardo de clientes (Consignación)
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-[2rem] shadow-xl border border-slate-100 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-2xl font-black text-[#1D3146]">
                ...
                <tr>
                  <td colSpan={4} className="p-20 text-center">
                    <p className="text-slate-400 font-bold italic">
                      No hay inventario fuera en este momento.
                    </p>
                  </td>
                </tr>
              ) : (
                  ...
                  >
                    <td className="px-8 py-5">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-[#1D3146] uppercase tracking-wide text-sm">
                          {item.customer_name}
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="px-8 py-5 text-right">
                      <div className="flex flex-col items-end">
                        ...
                        <span className="text-[10px] font-medium text-slate-400">
                          {new Date(item.last_movement).toLocaleTimeString([], {
                            hour: "2-digit",
                            minute: "2-digit",
                          })}
                        </span>
