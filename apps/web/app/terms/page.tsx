...
export default function TermsOfServicePage() {
  ...
  const content = {
    es: {
      ...
      subtitle:
        "El contrato de uso para operar tu negocio con la inteligencia de Entrega.",
      ...
      sections: [
        {
          ...
          content:
            "Al acceder o utilizar Entrega Intelligence, aceptas quedar vinculado por estos términos. Nuestra plataforma es una solución SaaS para logística y control de inventario.",
        },
        {
          id: "license",
          icon: Briefcase,
          ...
          content:
            "Otorgamos una licencia limitada, no exclusiva e intransferible para acceder a la plataforma según el plan contratado. El uso es exclusivo para fines comerciales legítimos.",
        },
        {
          id: "obligations",
          icon: Scale,
        ...
        },
        {
          ...
          content:
            "Los servicios se facturan por adelantado. La falta de pago resultará en la suspensión temporal del acceso a los datos operativos.",
        },
      ],
    },
    en: {
      ...
      subtitle:
        "The usage contract for operating your business with Entrega Intelligence.",
      back: "Back to Home",
      ...
      sections: [
        {
          ...
          content:
            "By accessing or using Entrega Intelligence, you agree to be bound by these terms. Our platform is a SaaS solution for logistics and inventory control.",
        },
        {
          id: "license",
          icon: Briefcase,
          title: "Usage License",
          content:
            "We grant a limited, non-exclusive, non-transferable license to access the platform according to the contracted plan. Use is exclusive for legitimate business purposes.",
        },
        {
          id: "obligations",
          icon: Scale,
      ...
      <main className="max-w-4xl mx-auto px-6 -mt-16 pb-20 relative z-20">
        <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-[#1D3146]/5 p-8 md:p-16 space-y-16">
          ...
          <footer className="pt-12 border-t border-slate-100 text-center">
            <Logo
              variant="master"
              className="h-12 w-auto opacity-20 mx-auto mb-4"
            />
