...
export default function DataDeletionPage() {
  ...
  const content = {
    es: {
      ...
      subtitle:
        "Instrucciones claras para solicitar la eliminación de tu información personal y operativa.",
      back: "Volver al Inicio",
      lastUpdated: "Última actualización: Abril 2026",
      instructions:
        "Para solicitar la eliminación de tus datos asociados con Entrega y nuestras integraciones (WhatsApp/Meta), sigue estos pasos:",
      steps: [
    ...
    en: {
      title: "Data Deletion",
      subtitle:
        "Clear instructions to request the deletion of your personal and operational information.",
      back: "Back to Home",
      lastUpdated: "Last updated: April 2026",
      instructions:
        "To request the deletion of your data associated with Entrega and our integrations (WhatsApp/Meta), please follow these steps:",
      steps: [
        ...
        <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-[#1D3146]/5 p-8 md:p-16 space-y-12">
              ...
              <ul className="space-y-4">
                {t.steps.map((step, i) => (
                  <li key={i} className="flex gap-4">
                    <div className="w-6 h-6 rounded-full bg-[#1D3146] text-[#56CCF2] text-[10px] font-black flex items-center justify-center shrink-0 mt-1">
                      {i + 1}
                    </div>
          ...
          <section className="bg-slate-50 rounded-3xl p-8 border border-slate-100 flex items-center gap-6">
            ...
            <a
              ...
              className="ml-auto hidden sm:flex items-center gap-2 bg-[#1D3146] text-[#56CCF2] px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:brightness-125 transition-all"
            >
