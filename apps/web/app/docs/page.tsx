    ...
    <div className="min-h-screen bg-[#F8FAFC] text-[#1D3146] font-sans">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <h1 className="text-4xl md:text-5xl font-black tracking-tight">Know How <span className="text-[#56CCF2] italic">Hub</span>.</h1>
          <p className="text-slate-500 font-medium max-w-2xl mx-auto italic">Documentación táctica diseñada por y para operadores de campo. Todo lo necesario para profesionalizar tu flota.</p>
        </div>
      </section>
      ...
      <section className="pb-32 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {resources.map((item, i) => (
            <div key={i} className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all group hover:-translate-y-2">
              ...
              <Link href={item.href} className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-[#56CCF2] group-hover:gap-4 transition-all">
