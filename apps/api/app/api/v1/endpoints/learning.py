...
from app.models.models import MessageLog, MessageCorrection, CustomerAlias, ProductAlias, User, Tenant
...
def get_message_logs(
    ...
    statement = select(MessageLog).where(MessageLog.tenant_id == tenant.id).order_by(MessageLog.timestamp.desc())
